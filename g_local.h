...
void	G_Spawn_Splash(int type, int count, int color, vec3_t start, vec3_t origin); //new
...
void fire_grenadeprox (edict_t *self, vec3_t start, vec3_t aimdir, int damage, int speed, float timer, float damage_radius, qboolean held); //NEW
void fire_greFlash (edict_t *self, vec3_t start, vec3_t aimdir, int damage, int speed, float timer, float damage_radius); //NEW
void fire_rocket (edict_t *self, vec3_t start, vec3_t dir, int damage, int speed, float damage_radius, int radius_damage);
void fire_rail (edict_t *self, vec3_t start, vec3_t aimdir, int damage, int kick);
void fire_bfg (edict_t *self, vec3_t start, vec3_t dir, int damage, int speed, float damage_radius);
void Fire_Homing_Grenade (edict_t *self, vec3_t start, vec3_t aimdir, int damage, int speed, float damage_radius); //NEW
