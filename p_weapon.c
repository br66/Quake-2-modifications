...
#define ALT_GRENADE_TIMER	9.0 //NEW - ALTERNATE GRENADE TIMER
...
void Weapon_RocketLauncher_Fire (edict_t *ent)
{
	...
	vec3_t	forward, right;
	int		damage;
	float	damage_radius; //WTF
	int		radius_damage; //ARE YOU FUCKING SERIOUS IS THIS A JOKE
	...
	VectorScale (forward, -2, ent->client->kick_origin);
	ent->client->kick_angles[0] = -1; //for the recoil?

	VectorSet(offset, 8, 8, ent->viewheight-8); //launcher is to the right of the player by 8
	P_ProjectSource (ent->client, ent->s.origin, offset, forward, right, start); // <<WTF
	fire_rocket (ent, start, forward, damage, 650, damage_radius, radius_damage);
	//fire_decoy (ent, start, up, 0, 650, 0.0, 0.0);
...
void Weapon_RocketLauncher (edict_t *ent)
{
	...
	static int	fire_frames[]	= {5, 0}; //so does it fire every 5 frames???
